...
<div class="full-page register-page section-image" filter-color="black" data-image="assets/img/img7.jpg">
    <div class="content">
        <div class="container">
            <div class="row">
            ...
            <form class="form" method="" action="#">
                                ...
                                <div class="input-group">
                                 ...
                                 <div class="input-group">
                                    ...
                                    <input type="passowrd" placeholder="passowrd" class="form-control">
                                </div>
