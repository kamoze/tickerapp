...
<head>
    ...
    <meta charset="utf-8" />
<link rel="apple-touch-icon" sizes="76x76" href="companyRegister/img/apple-icon.png">
<link rel="icon" type="image/png" href="companyRegister/img/favicon.png">
...
<link href="companyRegister/css/use.fontawesome.com/releases/v5.0.6/css/all.css" rel="stylesheet">
        ...
        function validateform(){
            //alert(" required");
                if(document.getElementById("firstname").value == '') {
                    ...
                    swal("First Name", "Please enter first name", "success")
                    //alert();
                    return false;
                }
                if(document.getElementById("lastname").value == '') {
                    //swal("Please Enter lastname")
                    swal("lastname", "Please enter lastname", "success")
                    //alert();
                    return false;
                }
...
<div class="full-page register-page section-image" filter-color="black" data-image="companyRegister/img/img7.jpg">
    <div class="content">
        <div class="container">
            <div class="row">
...
@endif
            ...
            <div class="input-group-prepend">
                                ...
                                <div class="input-group">
                                   ...
                                   <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Company Email..." id="companyemail" name="companyemail">
                                </div>
                                ...
                                <div class="input-group">
                                 ...
                                 <div class="input-group">
                                    ...
                                    <input type="passowrd" placeholder="password" class="form-control" id="password" name="password">
                                </div>
    ...
    <div class="card-footer ">
        <input type="submit" value ="Get Started"  class="btn btn-primary btn-round btn-lg" onclick="return validateform()"> 
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="copyright" id="copyright">
            &copy; <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script>, Designed by GeoTech</a>
        </div>
    </div>
...
<script src="companyRegister/js/plugins/jasny-bootstrap.min.js"></script>
...
<script src="companyRegister/demo/demo.js"></script>
  ...
  <!-- Sharrre libray -->
<script src="companyRegister/demo/jquery.sharrre.js"></script>
...
<!-- Mirrored from demos.creative-tim.com/now-ui-dashboard-pro/examples/pages/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Aug 2018 10:03:13 GMT -->
</html>
